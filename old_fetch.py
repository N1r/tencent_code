...
CONFIG = {
    ...
    # === 顶级高频源（日更10-20条，5分钟内）===
    'MeidasTouch': 'UC9r9HYFxEQOBXSopFS61ZWg',      # ⭐日更15条，反特朗普
    'The Hill': 'UCPWXiRWZ29zrxPFIQT7eHSA',         # ⭐日更20条，Breaking News
    'Forbes Breaking News': 'UCuTiq7iBWzbKfvTqNhUz7bg', # ⭐日更10条，国会听证
    'Tucker Carlson': 'UCxwubvG70lardn6CkfVdnSw',      # ⭐Tucker独立频道

    # === 次高频（日更5-10条，8分钟内）===
    'NBCNews': 'UCeY0bbntWzzVIaj2z3QigXg',          # 日更8条
    'CNN': 'UCupvZG-5ko_eiXAupbDfxWw',              # 日更6条
    'FoxNews': 'UCXIJgqnII2ZOINSWNOGFThA',          # 日更5条
    'ABC News': 'UCBi2mrWuNuyYy4gbM6fU18Q',         # 日更5条
    'Congress Clips': 'UCoQqYNMaXWaN3H50ntHjNkg',       # ⭐国会发言片段，日更10+
    'Stephen A Smith': 'UCo7ttKxbhLNS0fuQUIFrrAA',      # ⭐体育+政治，周更3-5条

    # === 个人主播高频（日更3-8条）===
    'briantylercohen': 'UCQANb2YPwAtK-IQJrLaaUFw',  # 日更5条，左翼
    'Ben Shapiro': 'UCnQC_G5Xsjhp9fEJKuIcrSw',      # 日更7条，右翼
    'Benny Johnson': 'UCfiCnGMHYrEWU97NAdzQ1Fw',    # 日更8条，保守派
    'David Pakman': 'UCvixJtaXuNdMPUGdOPcY8Ag',     # 日更4条，左翼
    },
